...
//
//     final rocketListModel = rocketListModelFromJson(jsonString);

import 'dart:convert';

List<RocketListModel> rocketListModelFromJson(String str) => List<RocketListModel>.from(json.decode(str).map((x) => RocketListModel.fromJson(x)));

String rocketListModelToJson(List<RocketListModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RocketListModel {
  ...
  factory RocketListModel.fromJson(Map<String, dynamic> json) => RocketListModel(
